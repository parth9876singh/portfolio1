...
const Home = () => (
  <main className="w-full relative">
    <Helmet>
      ...
      <meta name="keywords" content="Portfolio, Full Stack, React, Next.js, Web Development" />
...
const NotFound = () => (
  <div className="min-h-screen flex flex-col items-center justify-center text-center px-6">
    ...
    <a href="/" className="px-6 py-3 bg-white text-black font-medium rounded-full cursor-none">Go Home</a>
  </div>
);
