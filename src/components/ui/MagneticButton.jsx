...
const MagneticButton = ({ children, className = '', variant = 'primary', ...props }) => {
  ...
  const baseStyles = 'relative inline-flex items-center justify-center rounded-full font-medium transition-colors duration-300 overflow-hidden group px-8 py-4 z-10';
  
  const variants = {
    primary: 'bg-brand-cyan text-brand-base hover:bg-white',
    secondary: 'bg-transparent text-white border border-white/20 hover:border-brand-cyan glass-card',
