...
const AnimatedCounter = ({ from = 0, to, duration = 2, decimals = 0, suffix = "" }) => {
...
const CounterCard = ({ label, targetValue, decimals = 0, suffix = "" }) => (
  ...
  >
    ...
    <div className="absolute -inset-[1px] rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" style={{ boxShadow: '0 0 20px rgba(6, 182, 212, 0.15)' }} />
...
const About = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 px-6 lg:px-12 relative z-10 w-full overflow-hidden">
      ...
      >
        ...
        <motion.div variants={fadeLeft} className="lg:col-span-5 relative w-full flex items-center justify-center p-4">
        ...
        <motion.div variants={fadeRight} className="lg:col-span-7 flex flex-col space-y-8">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white leading-tight">
              Passionate about building <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-indigo to-brand-cyan text-glow">things that matter.</span>
            </h2>
          </div>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
