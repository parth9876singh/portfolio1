...
const colorMap = {
  "amber": "text-amber-400 bg-amber-400/10 border-amber-400/20 group-hover:border-amber-400/50",
  "blue": "text-blue-400 bg-blue-400/10 border-blue-400/20 group-hover:border-blue-400/50",
  "brand-indigo": "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20 group-hover:border-brand-indigo/50",
  "brand-cyan": "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20 group-hover:border-brand-cyan/50"
};
...
const Achievements = () => {
  ...
  return (
    <section id="achievements" ref={sectionRef} className="py-32 px-6 lg:px-12 relative w-full">
            ...
            return (
              ...
              >
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div>
                    {/* Badge */}
                    <div className={`inline-block px-3 py-1 rounded-full border text-xs font-semibold mb-4 ${config.badgeColor}`}>
                  ...
                  {/* Middle Section */}
                  <div className="my-6">
                    <div className={`p-4 w-fit rounded-xl border mb-4 ${config.iconBg}`}>
                    ...
                    <p className="text-sm font-sans text-gray-400 mt-2">{item.issuer}</p>
                    <p className="text-xs font-mono text-gray-500 mt-1">{item.date}</p>
                  </div>

                  {/* Bottom Section */}
                  <div>
                    {item.description && (
                      <p className="text-xs text-gray-400 mt-4">{item.description}</p>
                    )}
                    {item.verifyURL && (
