...
const Hero = () => {
  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
      {/* 3D Background */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full flex flex-col items-center md:items-start text-center md:text-left pt-20">
        ...
        <div className="hero-element text-2xl md:text-3xl lg:text-4xl font-display font-medium text-gray-300 mb-6 flex items-center justify-center md:justify-start gap-3 h-8 md:h-12 mt-4">
          <span>I'm a <span className="text-brand-cyan">{typeWriterText}</span><span className="animate-pulse text-brand-cyan ml-1">|</span></span>
        </div>
        ...
        <div className="hero-element flex items-center justify-center md:justify-start gap-6 mb-16 relative z-50">
          <a 
            ...
            title="GitHub"
          >
            <Github size={20} className="text-gray-300 group-hover:text-brand-indigo transition-colors" />
          </a>
          <a 
          ...
          <a 
            ...
            title="LeetCode"
          >
            <Code2 size={20} className="text-gray-300 group-hover:text-yellow-400 transition-colors" />
          </a>
        </div>
